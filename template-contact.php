...
<main id="primary" class="site-main font-sans bg-brand-50 pb-24 relative isolate">
    ...
    <section class="relative overflow-hidden bg-hero-gradient text-brand-950 pt-24 pb-32">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
            ...
            <p class="text-brand-700 text-lg">縺頑ｰ苓ｻｽ縺ｫ縺皮嶌隲・￥縺縺輔＞</p>
        </div>
            ...
            <div class="bg-white shadow-2xl rounded-3xl p-8 md:p-12 border-t-4 border-brand-500 relative overflow-hidden group">
                ...
                <div class="text-center mb-8 relative z-10">
                    <p class="text-gray-600 leading-relaxed text-lg">
                        縺雁撫縺・粋繧上○縺ｯ莉･荳九・繝輔か繝ｼ繝繧医ｊ縺企｡倥＞縺・◆縺励∪縺吶・br class="hidden md:block">
                        鬆・岼繧堤ｵ槭ｊ縲√Θ繝ｼ繧ｶ繝ｼ縺ｮ蠢・炊逧・ワ繝ｼ繝峨Ν繧剃ｸ九￡縺ｦ縺・∪縺吶・                    </p>
                </div>

                <?php
                // Contact Form 7 縺ｮ繧ｷ繝ｧ繝ｼ繝医さ繝ｼ繝峨ｒ諠ｳ螳・                // echo do_shortcode('[contact-form-7 id="YOUR_FORM_ID" title="Contact form 1"]');
                ?>

                <!-- 繝輔か繝ｼ繝萓・-->
                <form action="#" method="POST" class="space-y-6 relative z-10">
                    <div>
                        <label for="name" class="block text-sm font-bold text-gray-700 mb-1">縺雁錐蜑・<span class="text-red-500 ml-1">*</span></label>
                    ...
                    <div>
                        <label for="email" class="block text-sm font-bold text-gray-700 mb-1">繝｡繝ｼ繝ｫ繧｢繝峨Ξ繧ｹ <span class="text-red-500 ml-1">*</span></label>
                    ...
                    <div>
                        <label for="message" class="block text-sm font-bold text-gray-700 mb-1">縺雁撫縺・粋繧上○蜀・ｮｹ <span class="text-red-500 ml-1">*</span></label>
                    ...
                    <div class="text-center pt-4">
                        <p class="text-sm text-gray-500 mb-6">縺泌・蜉帙＞縺溘□縺・◆蛟倶ｺｺ諠・ｱ縺ｯ縲・a href="/privacy-policy" class="text-brand-600 hover:text-brand-800 underline transition-colors">繝励Λ繧､繝舌す繝ｼ繝昴Μ繧ｷ繝ｼ</a>縺ｫ蝓ｺ縺･縺阪・←蛻・↓蜿悶ｊ謇ｱ縺・∪縺吶・/p>
