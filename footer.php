<footer style="background-color: #3D2D3F !important; color: #FFFFFF !important; border-top: 4px solid #A184A3 !important; padding: 2rem !important;" class="relative overflow-hidden isolate">
    <div class="container mx-auto relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 pb-8">
            ...
            <div class="lg:col-span-4 flex flex-col justify-between space-y-4">
                <div>
                    <a href="<?php echo esc_url(home_url('/')); ?>" rel="home" class="inline-flex items-center space-x-3.5 group outline-none mb-3">
                        <div class="logo-wrapper relative w-10 h-10 flex items-center justify-center overflow-hidden rounded-xl bg-white shadow-sm group-hover:shadow-md transition-all duration-500 ring-1 ring-black/[0.03]">
                        ...
                        <div class="flex flex-col leading-none">
                            <span style="color: #D8BFD8 !important;" class="text-[9px] uppercase tracking-[0.25em] font-bold mb-1">MaruPlus Cube</span>
                            <div style="color: #FFFFFF !important;" class="text-base md:text-lg font-black tracking-tight">
                                マルプラス<span style="color: #D8BFD8 !important;" class="font-extrabold px-0.5">の</span>サンジョウ
                            </div>
                        </div>
                    </a>
                    <p style="color: #F1E6F2 !important;" class="text-xs leading-relaxed max-w-sm font-medium opacity-90">
            ...
            <div class="lg:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-6">
                <!-- Category 1: サービス・プロダクト -->
                <div>
                    <h5 style="color: #FFFFFF !important; border-bottom: 2px solid #A184A3 !important;" class="text-xs font-bold tracking-widest uppercase mb-3 pb-1 inline-block">
                        事業・プロダクト
                    </h5>
                    <ul class="space-y-2 text-xs list-none p-0 m-0">
        ...
        <div style="border-top: 1px solid rgba(255, 255, 255, 0.15) !important;" class="pt-4 flex flex-col md:flex-row justify-between items-center gap-4">
            <!-- Inline Sub-navigation -->
            <ul class="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs list-none p-0 m-0">
