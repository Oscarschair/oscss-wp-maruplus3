...
<main id="primary" class="site-main font-sans bg-gray-50 pb-0">
    <section class="relative overflow-hidden bg-hero-gradient text-brand-950 pt-32 pb-40 min-h-[75vh] flex flex-col justify-center items-center">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center my-auto">
            ...
            <p class="text-gray-900 text-xl md:text-2xl font-bold mb-8">
                ページが見つかりません
            </p>
            <div class="max-w-xl mx-auto bg-white/80 backdrop-blur-md text-gray-800 p-8 rounded-3xl border border-white/50 mb-12 shadow-2xl">
                <p class="text-gray-900 text-lg font-medium leading-relaxed">
                    お探しのページは、移動または削除されたか、<br class="hidden sm:block">URLが間違っている可能性があります。
                </p>
            </div>
            
            <a href="<?php echo esc_url(home_url('/')); ?>" class="inline-flex items-center justify-center px-10 py-5 bg-brand-600 text-white font-bold rounded-full shadow-lg hover:bg-brand-700 hover:shadow-brand-500/50 transition-all duration-300 transform hover:-translate-y-1 text-lg group">
