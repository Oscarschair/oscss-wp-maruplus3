    ...
    <div class="container mx-auto px-4 py-16">
        ...
        <section id="cubed-value" class="mb-16">
            ...
            <div class="max-w-4xl mx-auto text-lg text-center">
                ...
                <div class="text-2xl font-bold my-6">
                    ...
                    <span class="inline-block bg-lilac rounded-full px-4 py-2 text-black">次世代のマーケティング基盤構築</span>
                </div>
                <p>
        ...
        <section id="core-values">
            <div class="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
                <!-- 1. Data Enabler -->
                <div class="border rounded-lg p-6 bg-gold">
                    <h3 class="text-2xl font-bold mb-4">1.【Data Enabler】<br>データの実装と可視化</h3>
                    <p class="font-bold mb-4 text-gray-800">「見えないものを、意思決定できる形に変える」</p>
                ...
                <div class="border rounded-lg p-6 bg-silver">
                    <h3 class="text-2xl font-bold mb-4">2.【Marketing Architect】<br>仕組みの自動化と最適化</h3>
                    <p class="font-bold mb-4 text-gray-800">「バラバラな点と点を繋ぎ、自動で回る仕組みを作る」</p>
                ...
                <div class="border rounded-lg p-6 bg-copper">
                    <h3 class="text-2xl font-bold mb-4">3.【Global Tech Director】<br>越境実装とPM</h3>
                    <p class="font-bold mb-4 text-gray-800">「国境や技術の壁を越えてプロジェクトを完遂させる」</p>
